...
class EventScreen extends StatefulWidget {
  ...
  EventScreen({this.selectedOption, required this.height100, required this.onNextPressed});
            ...
            Row(
              children: [
                Expanded(
                  child: TextField(
                    keyboardType: TextInputType.number,
                    decoration: InputDecoration(labelText: 'Event Duration (hours)'),
                    onChanged: (value) {
                      setState(() {
                        eventDuration = Duration(hours: int.tryParse(value) ?? 0);
                      });
                    },
                  ),
                ),
